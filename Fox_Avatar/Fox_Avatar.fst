...
type = body+head
scale = 2
filename = Fox_Avatar/Fox_Avatar.fbx
texdir = Fox_Avatar/textures
...
jointIndex = Fox_dae_tail2_O_OBJ_O_SORTEACHNODE_1 = 1
jointIndex = RightHandPinky1 = 19
jointIndex = polySurface9 = 72
jointIndex = Fox_dae_tail2_O_OBJ_O_SORTEACHNODE_ = 66
jointIndex = LeftUpLeg = 7
jointIndex = polySurface5 = 70
jointIndex = polySurface1 = 75
jointIndex = LeftLeg = 8
jointIndex = LeftHandThumb1 = 59
jointIndex = scope_O_OBJ_O_HIR_O_SORTBIAS4__ = 83
jointIndex = RightFoot = 4
jointIndex = RightHandPinky3 = 21
jointIndex = Fox_Result_VIS_O_OBJ_ = 79
...
jointIndex = Fox_Hot_VIS_O_OBJ__Layer_3 = 81
