name = BrandBattleboss
type = body+head
scale = 1
filename = BrandBattleboss/BrandBattleboss.fbx
texdir = BrandBattleboss/textures
...
jointIndex = LeftForeArm = 21
jointIndex = RightFoot = 4
jointIndex = Spine2 = 14
jointIndex = LeftHand = 22
jointIndex = Spine = 12
